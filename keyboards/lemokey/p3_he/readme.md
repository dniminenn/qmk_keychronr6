...
![Lemokey P3 HE](https://cdn.shopify.com/s/files/1/0680/1778/3083/files/Lemokey_P3_HE_Wireless_Mechanical_Switch_Keyboard.jpg)

A customizable TKL hall effect keyboard.

* Keyboard Maintainer: [Keychron](https://github.com/keychron)
* Hardware Supported: Lemokey P3 HE
* Hardware Availability: [Lemokey P3 HE QMK/VIA Wireless Custom Mechanical Keyboard](https://www.lemokey.com/products/lemokey-p3-he-wireless-magnetic-switch-custom-gaming-keyboard)

## Option A: Build And Flash Firmware

Make example for this keyboard (after setting up your build environment):

    make lemokey/p3_he/ansi:lemokey

Flashing example for this keyboard:

    make lemokey/p3_he/ansi:lemokey:flash
